      ...
      <div className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-4xl bg-white text-[#333] font-[sans-serif]">
                ...
                <div className="mt-12">
                    ...
                    <ul className="mt-3">
                        <li className="flex items-center">
                            ...
                            <Link href="mailto:pranjalworkon@gmail.com" className="text-[#007bff] text-sm ml-3">
                                <small className="block">Mail</small>
                                <strong><></>Pranjal Jain</strong>
                            </Link>
                        </li>
                    </ul>
                </div>
                <div className="mt-12">
                    ...
                    <ul className="flex mt-3 space-x-4">
                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <Link href="https://github.com/Jain-Pranjal?">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                                    viewBox="0 0 24 24">
                                    <path
                        ...
                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <Link href="https://www.linkedin.com/in/pranjalll/">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                                    viewBox="0 0 511 512">
                                    <path
            ...
            <form className="ml-auo space-y-4">
                ...
                <input type='email' placeholder='Email' required name='email'
                    className="w-full rounded-md py-3 px-4 bg-gray-100 text-sm outline-[#007bff]"  value={formdata.email} onChange={handleChange}/>
