...
import {toggling} from '@/app/scripts/toggling'
const Navbar = () => {
  ...
  return (
    ...
    <section className='py-2 bg-[#d0ff00] text-black text-center px-10'>
      <p className='text-sm'>Feel free to give<strong><Link href="/feedback"> feedback 😁</Link></strong></p>
    </section>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/about'
              className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>About</Link>
          </li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/feature'
              className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Feature</Link>
          </li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/movie'
              className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Movies</Link>
          </li>
